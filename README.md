...
- react.js : 버튼 클릭되었을때 input에입력된 값을 알아오기 위해 useRef 함수사용 handleSearch 함수는 알아온 input값을 이용하여 클릭되었을때의 정보를 {onSearch} prop을 통해 app.jsx에 전달함
youtube.js에서 원하는 결과로 가공한 후 받아온 {youtube} prop을 이용해 전달
